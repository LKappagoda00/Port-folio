...
const About = () => {
    return (
        <div className=' bg-black text-white py-20' id='about'>
            <div className='mt-10 container mx-auto px-8 mt:px-16 lg:px-24'>
                <h2 className='text-4xl font-bold text-center mb-12'>About Me</h2>
                <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                    <img src={AboutImage} alt=""
                        className='w-full max-w-sm md:max-w-md lg:max-w-lg rounded object-cover md-10' />
                    <div className='flex-1'>
                        ...
                        <div className='mt-12 flex justify-center text-center text-align-center'>
                            <div>
