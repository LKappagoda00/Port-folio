  ...
  return (
    <div className='bg-black text-white text-center py-16'>
      ...
      <h1 className='text-4xl font-bold'>
        I'm {" "}
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Lahiru Kappagoda</span>
      ...
      <div className='mt-8 space-x-4'>
        ...
        <button className='bg-gradient-to-r from-blue-500 to-purple-500 text-white hidden md:inline
